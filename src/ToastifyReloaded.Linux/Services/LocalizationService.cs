...
public sealed class LocalizationService
{
    ...
    private static readonly Entry[] Entries =
    {
        ...
        new("InstallUpdates", "Installa automaticamente gli aggiornamenti Linux", "Automatically install Linux updates"),
        ...
        new("PreviewNotes", "Note Linux", "Linux notes"),
        ...
        new("AutoCheckUpdates", "Controlla automaticamente aggiornamenti Linux", "Automatically check for Linux updates"),
        ...
        new("NoUpdate", "Nessun aggiornamento Linux disponibile.", "No Linux update is available."),
        new("UpdateAvailable", "Nuovo aggiornamento Linux disponibile", "New Linux update available"),
